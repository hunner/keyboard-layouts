...
#define          ______HELM_LEFT_3________                       KC_Q   , KC_J   , KC_K

#define _______________HELM_RIGHT_1________________     KC_F   , KC_G   , KC_C   , KC_R   , KC_L
#define _______________HELM_RIGHT_2________________     KC_D   , RGUI_H , RALX_T , RCTL_N , RSFT_S
#define          ______HELM_RIGHT_3_______                       KC_M   , KC_W   , KC_V
