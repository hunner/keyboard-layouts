...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_HELM] = LAYOUT_wrapper(
    DF(_TAIPO),_______,_______,_______, _______,                   _______, _______, _______, _______, _______,
    _______________HELM_LEFT_1_________________,                   _______________HELM_RIGHT_1________________,
    _______________HELM_LEFT_2_________________, _______, _______, _______________HELM_RIGHT_2________________,
  ...
  [_AFT] = LAYOUT_wrapper(
    ...
    _______, _______AFT_LEFT_3________, _______, _______, _______, _______, _______AFT_RIGHT_3_______, _______
  ),


  [_TAIPO] = LAYOUT_wrapper(
    DF(_HELM),_______,_______, _______, _______,                   _______, _______, _______, _______, _______,
