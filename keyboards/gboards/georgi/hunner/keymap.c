...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [TAIPO_LAYER] = LAYOUT_georgi_wrapper(
        _______, TAIPO_1_LEFT______________________, _______, _______, TAIPO_1_RIGHT_____________________, _______,
